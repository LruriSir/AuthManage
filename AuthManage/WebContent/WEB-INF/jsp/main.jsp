...
<body>
	<div class="container">
        <div id="pf-hd">
            ...
            <div class="pf-user">
                ...
                <h4 class="pf-user-name ellipsis">${currentUserInfo.user_name }</h4>
                ...
                <div class="pf-user-panel">
                    <ul class="pf-user-opt">
                        ...
                        <li class="pf-logout">
                            <a href="${pageContext.request.contextPath }/userInfo/logout.action">
                                <i class="iconfont">&#xe60e;</i>
    ...
    <script type="text/javascript" src="${pageContext.request.contextPath }/js/menuInfo/main.js"></script>
</body>
</html>